...
export const head: HeadConfig[] = [
	...
	[
		...
		{
			rel: 'stylesheet',
			href: 'https://fonts.googleapis.cn/css2?family=JetBrains+Mono:ital,wght@0,100..800;1,100..800&family=Ubuntu:ital,wght@0,300;0,400;0,500;0,700;1,300;1,400;1,500;1,700&display=swap'
		}
	],

	// --- 基础和SEO元数据 ---
	['link', {rel: 'icon', href: 'https://ssu.noidx.sawahara.host/logo.webp'}],
	['meta', {name: 'author', content: '白彩恋, YumeYuka, Linso, 悠栾, 枫莹'}],
	['meta', {name: 'description', content: '更舒适地畅享 root 就此开始！'}],
	...
	['meta', {property: 'og:description', content: '更舒适地畅享 root 就此开始！'}],
	...
	['meta', {property: 'og:image:alt', content: 'SSU - 更舒适地畅享 root 就此开始！'}],
